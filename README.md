...
│                         ames_house_price_prediction and configuration for tools like black
│
...
│
└── ames_house_price_prediction   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes ames_house_price_prediction a Python module
    │
